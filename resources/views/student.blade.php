...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-md-5">
                <div class="card mb-3">
                    <img src="https://www.teachermagazine.com/assets/images/teacher/_articleimagetransform855x313/COVID-19-Early_years_teaching_and_learning.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Enter information of the new students</h5>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <section class="col-md-5">
                <div class="card mb-3">
                    <img src="https://images.indianexpress.com/2018/12/education-child.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
    ...
    <script src="{{asset('https://code.jquery.com/jquery-3.5.1.slim.min.js')}}" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>
